...
export const Navigation = props => (
  <Wrapper active={props.active}>
    ...
    <a target="_blank" rel="noopener noreferrer" href="https://drive.google.com/open?id=1cIji6tkznHoGmDc78zkWS5mVeiJngvZD" ><Tab style={{color:'white'}}>Resume<i className="fa fa-file"></i></Tab></a>
...
export const NavigationBlog = props =>  (
  <Wrapper active={props.active}>
    ...
    <a target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/1cIji6tkznHoGmDc78zkWS5mVeiJngvZD/view" ><Tab style={{color:'white'}}>Resume<i className="fa fa-file"></i></Tab></a>
